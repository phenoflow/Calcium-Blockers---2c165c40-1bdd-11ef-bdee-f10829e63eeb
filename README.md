...
Specify input dataset path in [Calcium-Blockers-inputs.yml](Calcium-Blockers-inputs.yml).

## Usage

Run: `cwltool Calcium-Blockers.cwl Calcium-Blockers-inputs.yml`
